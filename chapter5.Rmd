...
Let's look at the summaries of the scaled variables. See how the variables changed ( e.g. the means are now all at zero).
...
#### **Intepretation and analysis of PCA and the corresponding biplots**
...
**Analyzing the MCA's summary table**
